...
StyledRect {
        ...
        Item {
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    radius: Appearance.rounding.full
                    color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.error : root.modelData.urgency === NotificationUrgency.Low ? Colours.palette.surface_container_highest : Colours.palette.secondary_container
                    ...
                    Loader {
                        ...
                        sourceComponent: ColouredIcon {
                            ...
                            colour: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.on_error : root.modelData.urgency === NotificationUrgency.Low ? Colours.palette.on_surface : Colours.palette.on_secondary_container
                    ...
                    Loader {
                        ...
                        sourceComponent: StyledIcon {
                            ...
                            color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.on_error : root.modelData.urgency === NotificationUrgency.Low ? Colours.palette.on_surface : Colours.palette.on_secondary_container
    ...
    component Action: StyledRect {
        ...
        StateLayer {
            radius: Appearance.rounding.full
            color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.on_secondary : Colours.palette.on_surface
        ...
        StyledText {
            ...
            color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.on_secondary : Colours.palette.on_surface_variant
            font.pointSize: Appearance.font.size.small
        }
