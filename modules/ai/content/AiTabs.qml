...
// Tab bar for the AI panel: one uniform-width button per page (tabler icon +
// title) with an animated underline indicator. Direct port of
// modules/dashboard/content/DashboardTabs.qml.
Item {
    id: root
