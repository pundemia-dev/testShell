...
// Ported 1:1 from caelestia (components/Logo.qml) — the caelestia brand mark as
// vector ShapePaths. Placeholder branding: swap the paths for the pShell logo
// when one exists.
Item {
    id: root
    ...
    property color topColour: Colours.palette.primary
    property color bottomColour: Colours.palette.on_surface
