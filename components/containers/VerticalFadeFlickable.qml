...
// Ported from caelestia: a vertical StyledFlickable whose top/bottom edges fade
// out via a gradient alpha mask (Mask). Fades hide automatically when there is
// nothing to scroll past that edge.
StyledFlickable {
    id: root
